  ...
  return (
    <section id="tech-stack" className="relative overflow-hidden bg-[#030712] py-16 text-white sm:py-24 lg:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto mt-12 sm:mt-16 max-w-5xl overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] py-8 border-y border-white/5">
          <div className="flex w-max animate-marquee items-center text-slate-400">
            <div className="flex items-center justify-around gap-14 sm:gap-20 pr-14 sm:pr-20 line-clamp-1">
              <div className="flex items-center gap-3 sm:gap-4"><Smartphone className="text-[28px] sm:text-[32px] w-7 h-7 sm:w-8 sm:h-8 text-white" /><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Swift</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><Smartphone className="text-[28px] sm:text-[32px] w-7 h-7 sm:w-8 sm:h-8 text-[#3DDC84]" /><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Kotlin</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348" className="h-7 w-7 sm:h-8 sm:w-8 text-[#61DAFB]"><circle cx="0" cy="0" r="2.05" fill="currentColor"/><g stroke="currentColor" strokeWidth="1" fill="none"><ellipse rx="11" ry="4.2"/><ellipse rx="11" ry="4.2" transform="rotate(60)"/><ellipse rx="11" ry="4.2" transform="rotate(120)"/></g></svg><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">React Native</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><svg viewBox="0 0 100 100" className="h-7 w-7 sm:h-8 sm:w-8 text-[#54C5F8]"><path d="M50 10L10 50l40 40 40-40L50 10z" fill="currentColor"/></svg><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Flutter</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><Database className="text-[28px] sm:text-[32px] w-7 h-7 sm:w-8 sm:h-8 text-[#FFCA28]" /><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Firebase</span></div>
            </div>
            <div className="flex items-center justify-around gap-14 sm:gap-20 pr-14 sm:pr-20" aria-hidden="true">
              <div className="flex items-center gap-3 sm:gap-4"><Smartphone className="text-[28px] sm:text-[32px] w-7 h-7 sm:w-8 sm:h-8 text-white" /><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Swift</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><Smartphone className="text-[28px] sm:text-[32px] w-7 h-7 sm:w-8 sm:h-8 text-[#3DDC84]" /><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Kotlin</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348" className="h-7 w-7 sm:h-8 sm:w-8 text-[#61DAFB]"><circle cx="0" cy="0" r="2.05" fill="currentColor"/><g stroke="currentColor" strokeWidth="1" fill="none"><ellipse rx="11" ry="4.2"/><ellipse rx="11" ry="4.2" transform="rotate(60)"/><ellipse rx="11" ry="4.2" transform="rotate(120)"/></g></svg><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">React Native</span></div>
              <div className="flex items-center gap-3 sm:gap-4"><svg viewBox="0 0 100 100" className="h-7 w-7 sm:h-8 sm:w-8 text-[#54C5F8]"><path d="M50 10L10 50l40 40 40-40L50 10z" fill="currentColor"/></svg><span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white">Flutter</span></div>
