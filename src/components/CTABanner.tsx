    ...
    <section className="bg-brand-night py-14 text-white">
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            ...
            <a href="https://wa.me/919986389444" target="_blank" rel="noopener" className="inline-flex items-center gap-2 rounded-full bg-brand-leaf px-6 py-3 font-bold text-white"><MessageCircle className="" />Chat on WhatsApp</a>
        </div>
      </div>
    </section>
  );
